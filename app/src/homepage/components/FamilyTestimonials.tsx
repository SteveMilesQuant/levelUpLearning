        ...
        <Stack fontFamily="kent" width={width} spacing={spacing} paddingY={spacing}>
            ...
            <Stack>
                ...
                <HStack width="full" justify="space-around">
                    <Button variant="outline" isDisabled={currentIdx === 0} onClick={() => setCurrentIdx(currentIdx - 1)}>
                        <Text textColor="brand.gradient2" textAlign="center" fontSize={fontSize}>Prev</Text>
                    </Button>
                    <Button variant="outline" isDisabled={currentIdx === quoteList.length - 1} onClick={() => setCurrentIdx(currentIdx + 1)}>
